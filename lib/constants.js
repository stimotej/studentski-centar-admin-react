...
export const TEATAR_TD_ROLE = "teatar_td";
...
export const teatarTdPagesCategoryId = 356;
...
export const getMediaUncategorizedFolderId = (categoryId) => {
  switch (categoryId) {
    ...
    case teatarTdCategoryId:
      return mediaUncategorizedFolderTeatarTd;
    default:
