...
export const faqStudentServisCategoryId = 172;
export const faqKulturaCategoryId = 174;
export const faqPrehranaCategoryId = 178;
export const faqSmjestajCategoryId = 179;
export const faqSportCategoryId = 180;
